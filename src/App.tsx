            ...
            <div className="hero-image">
              <div className="food-circle">
                <div className="food-item">
                  <img src="https://images.unsplash.com/photo-1562967914-608f82629710?ixlib=rb-1.2.1&auto=format&fit=crop&w=200&q=80" alt="Cocktail" />
                </div>
                <div className="food-item">
                  <img src="https://images.unsplash.com/photo-1568901346375-23c9450c58cd?ixlib=rb-1.2.1&auto=format&fit=crop&w=200&q=80" alt="Burger" />
                </div>
                <div className="food-item">
                  <img src="https://images.unsplash.com/photo-1513104890138-7c749659a591?ixlib=rb-1.2.1&auto=format&fit=crop&w=200&q=80" alt="Pizza" />
                </div>
                <div className="food-item">
                  <img src="https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?ixlib=rb-1.2.1&auto=format&fit=crop&w=200&q=80" alt="Pizza" />
                </div>
                <div className="food-item">
                  <img src="https://images.unsplash.com/photo-1565299585323-38d6b0865b47?ixlib=rb-1.2.1&auto=format&fit=crop&w=200&q=80" alt="Pizza" />
                </div>
                <div className="food-item">
        ...
        <div className="container">
          <div className="why-choose-content">
            ...
            <div className="why-choose-image">
              <img src="src\assets\abouthome.jpg" alt="Restaurant Interior" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="heritage-content">
            ...
            <div className="heritage-image">
              <img src="https://images.unsplash.com/photo-1546069901-ba9599a7e63c?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80" alt="Poke Bowl" />
            </div>
          </div>
        ...
        <div className="container">
          <div className="locations-card">
            ...
            <div className="locations-images">
              ...
              <div className="location-image">
                <img src="https://images.unsplash.com/photo-1547592180-85f173990554?ixlib=rb-1.2.1&auto=format&fit=crop&w=200&q=80" alt="Poke Bowl" />
              </div>
            </div>
          </div>
        </div>
